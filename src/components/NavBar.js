...
const NAV_ITEMS = ['Platform', 'Features', 'Roles', 'About'];
    ...
    <>
      <View style={styles.nav}>
        ...
        <View style={styles.liveBadge}>
          ...
          <Text style={styles.liveText}>LIVE — UNIZIK</Text>
        </View>
        ...
        {!IS_SMALL && (
          <TouchableOpacity
            ...
            onPress={() => Linking.openURL('https://wa.me/message/BFK5N4OMHUXXG1')}
          >
            <Text style={styles.ctaBtnText}>Request Access ↗</Text>
          </TouchableOpacity>
        )}
      ...
      {menuOpen && IS_SMALL && (
        <>
          ...
          >
            ...
            {/* Live status in drawer */}
            <View style={styles.drawerLiveBadge}>
              <View style={styles.liveDot} />
              <Text style={styles.drawerLiveText}>Currently live at Nnamdi Azikiwe University</Text>
            </View>
            ...
            <TouchableOpacity
              ...
              onPress={() => Linking.openURL('https://wa.me/message/BFK5N4OMHUXXG1')}
            >
              <Text style={styles.drawerCtaText}>Request Access ↗</Text>
            </TouchableOpacity>

            <Text style={styles.drawerBrand}>PROXAFRICA · CAMPUS FINANCE OS</Text>
          </Animated.View>
        </>
      )}
    </>
