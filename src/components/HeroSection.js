...
export default function HeroSection() {
  ...
  const openApp = async () => {
    const url = 'https://web.proxafrica.com';
  ...
  const openWhatsApp = async () => {
    const url =
      'https://wa.me/message/BFK5N4OMHUXXG1';
    ...
    <View style={styles.hero}>
      ...
      >
        ...
        <Text style={styles.tag}>
          Campus Finance OS — Built for Nigerian
          Universities
        </Text>
      </Animated.View>
      ...
      >
        ...
        <Text style={styles.titleMd}>
          FEE{' '}
          <Text style={styles.titleAccent2}>
            CHAOS
          </Text>
        </Text>
      </Animated.View>
      ...
      >
        ...
        <Text style={styles.subAccent}>
          fee collection process
        </Text>{' '}
        between course reps, students, and
        faculty — eliminating cash handling,
        lost receipts, and payment disputes.
      </Animated.Text>
